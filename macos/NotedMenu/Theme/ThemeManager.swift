...
struct ThemeColors {
    ...
    // NSColor versions for AppKit components
    var nsBackground: NSColor { NSColor(background) }
    var nsSecondaryBackground: NSColor { NSColor(secondaryBackground) }
    var nsTertiaryBackground: NSColor { NSColor(tertiaryBackground) }
    ...
    static let system = ThemeColors(
        ...
        tertiaryBackground: Color(nsColor: .tertiarySystemFill),
